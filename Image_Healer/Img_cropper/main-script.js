...
var side_control_page_1 = document.querySelector('.side-control-pg1')
var side_control_page_2 = document.querySelector('.side-control-pg2')
var actionButton = document.querySelectorAll('.action-btn button')
var hiddenUpload = document.querySelector('.action-btn .hidden-upload')
...
var zoom = document.querySelectorAll('.side-control-pg1 .zoom svg')
var rotate = document.querySelectorAll('.side-control-pg1 .rotate svg')
var flip = document.querySelectorAll('.side-control-pg1 .flip svg')
var move = document.querySelectorAll('.side-control-pg1 .move svg')
var aspectRatio = document.querySelectorAll('.side-control-pg2 .aspect li')
var controlCropper = document.querySelectorAll('.bottom-ctrl .ctrl-cropper svg')
var lockCropper = document.querySelectorAll('.bottom-ctrl .lock svg')
var dargMode = document.querySelectorAll('.bottom-ctrl .drag-mode svg')
